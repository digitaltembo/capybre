...
class FetchMetadataTest(TestCase):
    ...
    def test_fetch_by_title(self):
        # technically this works, although multiple books with the same name seem to just return the first book it finds
    ...
    def test_fetch_by_title_and_awthos(self):
        ...
        metadata = fetch_metadata(title='Pride and Prejdice', author='Jane Austen')
    ...
    def test_fetched_metadata_and_cover(self):
        ...
        c_file = None
        with fetched_metadata_and_cover(isbn='9780679783268') as (metadata, cover):
            c_file = cover
